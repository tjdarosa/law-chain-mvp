...
process.env = Object.assign(process.env, {
    HLF_CONNECTION_PROFILE_COLLECTINGOFFICER: '{"name":"mock-profile-collectingofficer"}',
    HLF_CERTIFICATE_COLLECTINGOFFICER:
        '"-----BEGIN CERTIFICATE-----\\nMOCK\\n-----END CERTIFICATE-----\\n"',
    HLF_PRIVATE_KEY_COLLECTINGOFFICER:
        '"-----BEGIN PRIVATE KEY-----\\nMOCK\\n-----END PRIVATE KEY-----\\n"',
    HLF_CONNECTION_PROFILE_EVIDENCECUSTODIAN: '{"name":"mock-profile-evidencecustodian"}',
    HLF_CERTIFICATE_EVIDENCECUSTODIAN:
        '"-----BEGIN CERTIFICATE-----\\nMOCK\\n-----END CERTIFICATE-----\\n"',
    HLF_PRIVATE_KEY_EVIDENCECUSTODIAN:
        '"-----BEGIN PRIVATE KEY-----\\nMOCK\\n-----END PRIVATE KEY-----\\n"',
    COLLECTINGOFFICER_APIKEY: 'COLLECTINGOFFICERMOCKAPIKEY',
    EVIDENCECUSTODIAN_APIKEY: 'EVIDENCECUSTODIANMOCKAPIKEY',
});
