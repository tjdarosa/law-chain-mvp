...
const cryptoPathCollectingOfficer = path.resolve(
    __dirname,
    '..',
    '..',
    '..',
...
// Path to collectingofficer user private key directory.
export const keyDirectoryPathCollectingOfficer = path.resolve(
    cryptoPathCollectingOfficer,
    'users',
...
// Path to collectingofficer user certificate.
export const certDirectoryPathCollectingOfficer = path.resolve(
    cryptoPathCollectingOfficer,
    'users',
    'User1@collectingofficer.example.com',
    'msp',
...
// Path to collectingofficer peer tls certificate.
export const tlsCertPathCollectingOfficer = path.resolve(
    cryptoPathCollectingOfficer,
    'peers',
