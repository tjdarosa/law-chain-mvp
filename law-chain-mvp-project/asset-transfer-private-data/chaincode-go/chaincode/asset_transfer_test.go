...
const myCollectingOfficerMsp = "CollectingOfficerTestmsp"
const myCollectingOfficerClientid = "myCollectingOfficerUserid"
const myCollectingOfficerPrivCollection = "CollectingOfficerTestmspPrivateCollection"
const myEvidenceCustodianMsp = "EvidenceCustodianTestmsp"
const myEvidenceCustodianClientid = "myEvidenceCustodianUserid"
const myEvidenceCustodianPrivCollection = "EvidenceCustodianTestmspPrivateCollection"
...
func TestCreateAssetSuccessful(t *testing.T) {
	...
	require.Equal(t, myCollectingOfficerPrivCollection, calledCollection)
	require.Equal(t, "id1", calledId)
...
func TestAgreeToTransferSuccessful(t *testing.T) {
	...
	require.Equal(t, []byte(myCollectingOfficerClientid), calledWithDataBytes)
}
func TestTransferAssetBadInput(t *testing.T) {
	...
	assetNewOwner = &assetTransferTransientInput{
		ID:       "id1",
		BuyerMSP: myEvidenceCustodianMsp,
	}
	setReturnAssetOwnerInTransientMap(t, chaincodeStub, assetNewOwner)
	// asset does not exist
	setReturnPrivateDataInStub(t, chaincodeStub, nil)
...
func TestTransferAssetSuccessful(t *testing.T) {
	...
	// to ensure that ReadTransferAgreement call returns evidencecustodian client ID
	chaincodeStub.GetPrivateDataReturnsOnCall(1, []byte(myEvidenceCustodianClientid), nil)
	chaincodeStub.CreateCompositeKeyReturns(transferAgreementObjectType+"id1", nil)
	...
	expectedNewAsset.Owner = myEvidenceCustodianClientid
...
func TestTransferAssetByNonOwner(t *testing.T) {
	...
	assetNewOwner := &assetTransferTransientInput{
		ID:       "id1",
		BuyerMSP: myCollectingOfficerMsp,
	}
	setReturnAssetOwnerInTransientMap(t, chaincodeStub, assetNewOwner)
	// Try to transfer asset owned by EvidenceCustodian
	evidencecustodianAsset := chaincode.Asset{
		ID:    "id1",
		Type:  "testfulasset",
		Color: "gray",
		Size:  7,
		Owner: myEvidenceCustodianClientid,
	}
	setReturnPrivateDataInStub(t, chaincodeStub, &evidencecustodianAsset)
	err := assetTransferCC.TransferAsset(transactionContext)
...
func prepMocksAsCollectingOfficer() (*mocks.TransactionContext, *mocks.ChaincodeStub) {
	return prepMocks(myCollectingOfficerMsp, myCollectingOfficerClientid)
}
func prepMocksAsEvidenceCustodian() (*mocks.TransactionContext, *mocks.ChaincodeStub) {
	return prepMocks(myEvidenceCustodianMsp, myEvidenceCustodianClientid)
}
