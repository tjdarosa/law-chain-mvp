...
public final class AssetTransferTest {
    ...
    class InvokeWriteTransaction {
        ...
        public void transferAssetWhenExistingAssetIsTransferred() {
            ...
            when(ctx.getClientIdentity()).thenReturn(ci);
            when(ci.getMSPID()).thenReturn(TEST_ORG_1_MSP);
            final String recipientOrgMsp = "TestEvidenceCustodian";
            final String buyerIdentity = "TestEvidenceCustodianUser";
            Map<String, byte[]> m = new HashMap<>();
    ...
    private static final String TEST_ORG_1_MSP = "TestCollectingOfficer";
    private static final String TEST_ORG_1_USER = "testCollectingOfficerUser";
    ...
    private static final byte[] DATA_ASSET_1_BYTES = "{ \"objectType\": \"testasset\", \"assetID\": \"asset1\", \"color\": \"blue\", \"size\": 5, \"owner\": \"testCollectingOfficerUser\", \"appraisedValue\": 300 }".getBytes();
}
