...
export MSP_ID=${MSP_ID:-CollectingOfficerMSP}
export CRYPTO_PATH=${CRYPTO_PATH:-../../test-network-k8s/build/channel-msp/peerOrganizations/collectingofficer}
export KEY_DIRECTORY_PATH=${KEY_DIRECTORY_PATH:-../../test-network-k8s/build/enrollments/collectingofficer/users/collectingofficeradmin/msp/keystore}
export CERT_DIRECTORY_PATH=${CERT_DIRECTORY_PATH:-../../test-network-k8s/build/enrollments/collectingofficer/users/collectingofficeradmin/msp/signcerts}
export TLS_CERT_PATH=${TLS_CERT_PATH:-../../test-network-k8s/build/channel-msp/peerOrganizations/collectingofficer/msp/tlscacerts/tlsca-signcert.pem}
export PEER_ENDPOINT=${PEER_ENDPOINT:-collectingofficer-peer1.localho.st:443}
export PEER_HOST_ALIAS=${PEER_HOST_ALIAS:-collectingofficer-peer1.localho.st}
