...
// const keyPath = WORKSHOP_CRYPTO + "/enrollments/collectingofficer/users/collectingofficeruser/msp/keystore/key.pem";
// const certPath = WORKSHOP_CRYPTO + "/enrollments/collectingofficer/users/collectingofficeruser/msp/signcerts/cert.pem"
// const tlsCertPath = WORKSHOP_CRYPTO + "/channel-msp/peerOrganizations/collectingofficer/msp/tlscacerts/tlsca-signcert.pem";
...
const peerEndpoint = "test-network-collectingofficer-peer1-peer.localho.st:443";
const peerHostAlias = "test-network-collectingofficer-peer1-peer.localho.st";
