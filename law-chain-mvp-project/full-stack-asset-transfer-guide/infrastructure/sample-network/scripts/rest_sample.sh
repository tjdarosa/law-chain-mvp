...
export USERNAME=evidencecustodianuser
export PASSWORD=collectingofficeruser
...
CONFIG_DIR=${TEMP_DIR}/fabric-rest-sample-config 
  ...
  local ca_pem=$ENROLLMENT_DIR/collectingofficer/users/$USERNAME/msp/signcerts/cert.pem
  local keyPath=$ENROLLMENT_DIR/collectingofficer/users/$USERNAME/msp/keystore/key.pem
