...
const (
	...
	tlsCertPath  = "../../test-network/organizations/peerOrganizations/collectingofficer.example.com/peers/peer0.collectingofficer.example.com/tls/ca.crt"
...
func newGrpcConnection() *grpc.ClientConn {
	...
	transportCredentials := credentials.NewClientTLSFromCert(certPool, "peer0.collectingofficer.example.com")
