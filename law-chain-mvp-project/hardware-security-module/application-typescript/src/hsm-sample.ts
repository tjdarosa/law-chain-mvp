...
const tlsCertPath = path.resolve(__dirname, '..', '..', '..', 'test-network','organizations','peerOrganizations', 'collectingofficer.example.com', 'peers', 'peer0.collectingofficer.example.com', 'tls', 'ca.crt');
