...
in the core.yaml file.  Note that each node's [environment](../kube/collectingofficer/collectingofficer-peer1.yaml) includes pointers to the
...
- CollectingOfficer (collectingofficer.example.com):
  - ECert Certificate Authority : https://collectingofficer-ca
  - Peer Node 1 : grpcs://collectingofficer-peer1
  - Peer Node 2 : grpcs://collectingofficer-peer2


- EvidenceCustodian (evidencecustodian.example.com):
  - ECert Certificate Authority : https://evidencecustodian-ca
  - Peer Node 1 : grpcs://evidencecustodian-peer1
  - Peer Node 2 : grpcs://evidencecustodian-peer2
