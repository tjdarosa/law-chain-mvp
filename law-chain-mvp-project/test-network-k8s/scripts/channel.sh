...
function register_org_admins() {
  ...
  register_org_admin collectingofficer collectingofficeradmin collectingofficeradminpw
  register_org_admin evidencecustodian evidencecustodianadmin evidencecustodianadminpw
...
function enroll_org_admins() {
  ...
  enroll_org_admin peer     collectingofficer collectingofficeradmin collectingofficeradminpw
  enroll_org_admin peer     evidencecustodian evidencecustodianadmin evidencecustodianadminpw
...
function create_channel_MSP() {
  ...
  create_channel_org_MSP collectingofficer peer $COLLECTINGOFFICER_NS
  create_channel_org_MSP evidencecustodian peer $EVIDENCECUSTODIAN_NS
...
function join_channel_peers() {
  join_org_peers collectingofficer
  join_org_peers evidencecustodian
}
