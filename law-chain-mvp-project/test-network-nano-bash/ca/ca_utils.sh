...
createEnrollment() {
  ...
  local orgname=$4          # name of the org (e.g. CollectingOfficer, EvidenceCustodian)  can be blank
...
createMSP() {
  ...
  local caname=$1       # name of the ca (ordererca, collectingofficerca, evidencecustodianca)
  local orgname=$2      # name of the org (collectingofficer, evidencecustodian)  Ordering Org is blank
...
registerAndEnroll() {
  ...
  local orgname=$5           # name of the org (e.g. CollectingOfficer, EvidenceCustodian)  can be blank
