...
# It joins the courtroompersonnel peers to the channel previously setup in
...
infoln "Joining courtroompersonnel peer to the channel..."
joinChannel 5

infoln "Setting anchor peer for courtroompersonnel..."
setAnchorPeer 5

successln "Channel '$CHANNEL_NAME' joined"
successln "CourtroomPersonnel peer successfully added to network"
