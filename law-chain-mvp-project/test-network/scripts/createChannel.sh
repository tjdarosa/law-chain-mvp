...
infoln "Joining collectingofficer peer to the channel..."
joinChannel 1
infoln "Joining evidencecustodian peer to the channel..."
joinChannel 2

## Set the anchor peers for each org in the channel
infoln "Setting anchor peer for collectingofficer..."
setAnchorPeer 1
infoln "Setting anchor peer for evidencecustodian..."
setAnchorPeer 2
