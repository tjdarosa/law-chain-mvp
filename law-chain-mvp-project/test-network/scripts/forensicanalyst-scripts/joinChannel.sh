...
infoln "Joining forensicanalyst peer to the channel..."
joinChannel 3

infoln "Setting anchor peer for forensicanalyst..."
setAnchorPeer 3

successln "Channel '$CHANNEL_NAME' joined"
successln "ForensicAnalyst peer successfully added to network"
