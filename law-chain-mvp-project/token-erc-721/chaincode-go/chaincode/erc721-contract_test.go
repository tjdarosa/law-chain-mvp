...
const owner = "x509::CN=minter,OU=client,O=Hyperledger,ST=North Carolina,C=US::CN=ca.collectingofficer.example.com,O=collectingofficer.example.com,L=Durham,ST=North Carolina,C=US"
const operator = "x509::CN=org,OU=client,O=Hyperledger,ST=North Carolina,C=US::CN=ca.collectingofficer.example.com,O=collectingofficer.example.com,L=Durham,ST=North Carolina,C=AR"
...
func setupStub() (*MockContext, *MockStub) {
	...
	mci.On("GetMSPID").Return("CollectingOfficerMSP", nil)
